...
grep -Fq 'Programa de Aceleração de Consultório: [Praxios](https://www.pda.praxios.com.br/)<br>' "$readme"
grep -Fq 'Instagram: [@cassiano.diniz](https://www.instagram.com/cassiano.diniz/)' "$readme"
grep -Fq 'Instale como uma skill pessoal a pasta `cass-pesquisa` deste repositório: https://github.com/cassianodiniz/cass-pesquisa/tree/main/cass-pesquisa. Depois execute `/cass-pesquisa`; antes de cair na busca nativa, procure a Exa.' "$readme"
grep -Fq '## Materiais complementares' "$readme"
grep -Fq 'Open Evidence: [https://www.openevidence.com/](https://www.openevidence.com/)' "$readme"
grep -Fq 'GPT Schoolar: [https://chatgpt.com/g/g-kZ0eYXlJe-scholar-gpt](https://chatgpt.com/g/g-kZ0eYXlJe-scholar-gpt)' "$readme"
grep -Fq 'BUSCA GUIADA DE ARTIGOS CIENTÍFICOS' "$readme"
grep -Fq 'ANTES de iniciar a busca, me faça apenas estas 3 perguntas' "$readme"
grep -Fq 'Evite linguagem técnica desnecessária e foque na aplicação prática.' "$readme"
